...
class MockLLMClient:
    ...
    def __init__(
        self, mock_responses: dict[type[ContextFlowSchema], MockResponse] | None = None
    ) -> None:
                ...
                for field_name, field_info in response_model.model_fields.items():
                    if field_info.is_required():
                        ...
                        if field_info.annotation is str:
                            ...
                            "dict" in annotation_str.lower() or "Dict" in annotation_str
                        ):
                            field_defaults[field_name] = {}
                        else:
...
class InstructorFlow:
    ...
    def to_flow(self) -> Flow[Context, Context]:
    ...
    async def _instructor_pipeline(
        self, stream: AsyncGenerator[Context, None]
    ...
    def _extract_input_from_context(self, context: Context) -> ContextFlowSchema:
    ...
    def _build_messages(self, input_data: ContextFlowSchema) -> list[MessageData]:
    ...
    def _format_input_as_prompt(self, input_data: ContextFlowSchema) -> str:
        ...
        return "\n".join(prompt_parts)  # pyright: ignore[reportUnknownArgumentType]
...
def create_instructor_flow(
    ...
    **kwargs: FlowKwargs,
    ...
    return instructor_flow.to_flow()
