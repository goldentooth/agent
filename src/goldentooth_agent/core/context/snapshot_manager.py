...
if TYPE_CHECKING:
    from .main import Context, ContextSnapshot
...
class SnapshotManager:
    ...
    def create_snapshot(self, context: Context, name: str) -> ContextSnapshot:
    ...
    def restore_snapshot(self, context: Context, name: str) -> None:
