...
class EmbeddingsService:
    ...
    async def create_document_embedding(self, document_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _extract_embeddable_text(self, document_data: Dict[str, Any]) -> str:
        ...
        doc_type = document_data.get("service_type") or document_data.get("category", "")
        if doc_type:
