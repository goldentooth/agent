...
class VectorStore:
    ...
    def _init_database(self) -> None:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            try:
                ...
                print(f"Warning: vec0 extension not available ({e}), using fallback table")
                conn.execute("""
    ...
    def _init_metadata(self) -> None:
        ...
        if not self.metadata_path.exists():
            ...
            self.metadata_path.write_text(json.dumps(default_metadata, indent=2))
    ...
    def _save_sidecar_embedding(self, store_type: str, document_id: str, embedding: List[float]) -> None:
        ...
        # Update metadata
        self._update_metadata(store_type, document_id, sidecar_path)
    
    def _load_sidecar_embedding(self, store_type: str, document_id: str) -> Optional[List[float]]:
    ...
    def _update_metadata(self, store_type: str, document_id: str, sidecar_path: Path) -> None:
    ...
    def store_document(
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            """, (
                doc_id, store_type, document_id, content,
            ...
            try:
                ...
                """, (
                    doc_id, store_type, document_id, content_preview, embedding_blob, now
                ))
    ...
    def search_similar(
        ...
        with sqlite3.connect(self.db_path) as conn:
            try:
                ...
                return self._fallback_similarity_search(query_embedding, limit, store_type, conn)
    ...
    def _fallback_similarity_search(
        ...
        for row in cursor.fetchall():
            ...
            similarities.append((similarity, doc_id, store_type, document_id, content_preview))
    ...
    def delete_document(self, doc_id: str) -> bool:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            try:
                cursor2 = conn.execute("DELETE FROM embeddings WHERE doc_id = ?", (doc_id,))
            except sqlite3.OperationalError:
                cursor2 = conn.execute("DELETE FROM embeddings_fallback WHERE doc_id = ?", (doc_id,))
            ...
            for store_type, document_id in cursor.fetchall():
                try:
                    ...
                    if embedding:
                        ...
                        self._save_sidecar_embedding(store_type, document_id, embedding)
                        created_files.append(self._get_sidecar_path(store_type, document_id))
    ...
    def _get_embedding_from_db(self, store_type: str, document_id: str) -> Optional[List[float]]:
        """Get embedding from database.
