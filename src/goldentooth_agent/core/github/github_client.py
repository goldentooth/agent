...
class GitHubClient:
    ...
    def get_organization(self, org_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ValueError(f"Failed to retrieve organization '{org_name}': {e}") from e
    ...
    def get_organization_repos(
        ...
        try:
            ...
            raise ValueError(f"Failed to retrieve repositories for '{org_name}': {e}") from e
    ...
    def get_user_repos(
        ...
        try:
            ...
            raise ValueError(f"Failed to retrieve repositories for '{username_str}': {e}") from e
    
    def sync_organization(self, org_name: str, include_repos: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            if include_repos:
                ...
                repos_data = self.get_organization_repos(org_name, max_repos=50)  # Reasonable limit
    ...
    def _extract_repo_data(self, repo: Repository) -> Dict[str, Any]:
        ...
        try:
            ...
            primary_language = max(languages_dict.items(), key=lambda x: x[1])[0] if languages_dict else None
        except Exception:
            languages = []
