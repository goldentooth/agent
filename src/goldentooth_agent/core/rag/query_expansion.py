...
class QueryExpansionEngine:
    ...
    def __init__(self):
        ...
        self.stop_words = {
            ...
            "this", "these", "those", "them", "they", "their", "there", "then",
            "than", "very", "more", "most", "some", "any", "all", "each",
    ...
    def analyze_query_quality(self, query: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "analysis": {
                ...
                "technical_terms": len([t for t in key_terms if self._is_technical_term(t)]),
            },
        }
    ...
    def _generate_synonyms(
        ...
        for term in key_terms:
            ...
            if domain_context and domain_context in self.contextual_expansions:
                ...
                if term in context_terms or any(syn in context_terms for syn in term_synonyms):
    ...
    def _is_technical_term(self, term: str) -> bool:
        ...
        technical_indicators = [
            ...
            # Technologies
            "docker", "kubernetes", "git", "api", "database", "server",
            # Concepts
    ...
    def _generate_suggestions(
        ...
        if intent == QueryIntent.GENERAL:
            ...
            suggestions.append("Add context words like 'how to', 'what is', or 'example of'")
        ...
        if any(self._is_technical_term(term) for term in key_terms):
            suggestions.append("Include version numbers or specific technologies if relevant")
    ...
    def _create_synonym_strategy(self, expansion: QueryExpansion) -> SearchStrategy:
        ...
        for expanded in expansion.expanded_queries[1:4]:  # Skip original, take next 3
            if any(syn in expanded for synonyms in expansion.synonyms.values() for syn in synonyms):
    ...
    def _create_related_terms_strategy(self, expansion: QueryExpansion) -> SearchStrategy:
    ...
    def _generate_improvements(
        ...
        if metrics["clarity_score"] < 0.6:
            improvements.append("Add question words like 'how to', 'what is', or 'why does'")
        
        if intent == QueryIntent.GENERAL:
            improvements.append("Be more specific about what you want to learn or accomplish")
