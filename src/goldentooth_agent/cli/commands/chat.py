...
def chat(
  ...
  def handle(
    ...
    from goldentooth_agent.core.agent import agent_chain, inject_agent, inject_agent_text
    from goldentooth_agent.core.command import command_chain, register_all_commands
    ...
    chain = compose_chain(
      ...
      inject_agent_text(),      # Inject the agent's text representation.
