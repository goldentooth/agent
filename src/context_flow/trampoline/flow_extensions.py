"""Flow class extensions for trampoline execution patterns.

This module provides the extend_flow_with_trampoline function and related
functionality that adds trampoline-related convenience methods to the Flow class.
"""
...
from .constants import async_iter_from_item

__all__ = ["extend_flow_with_trampoline"]
...
def extend_flow_with_trampoline() -> None:
    ...
    def run_single(self: "Flow[Any, Any]", item: Any) -> Any:
        ...
        async def _run() -> Any:
            stream = async_iter_from_item(item)
    ...
    def as_single_stream(self: "Flow[Any, Any]", item: Any) -> "Flow[Any, Any]":
        ...
        async def _single_stream_flow(
            ...
            single_item_stream = async_iter_from_item(item)
        ...
        async def _repeat_until_flow(
            ...
            async for initial_item in stream:
                ...
                while True:
                    ...
                    single_stream = async_iter_from_item(current_item)
