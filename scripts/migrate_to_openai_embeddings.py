        ...
        try:
            ...
            for doc_id in document_ids:
                ...
                try:
                    ...
                    embedding_result = await openai_embeddings.create_document_embedding(doc_data)
                    ...
                    if total_processed % 10 == 0:
                        print(f"    ✅ Processed {total_processed}/{total_docs} documents...")
            ...
            for doc_id in document_ids:
                try:
                    ...
                    if openai_embeddings.should_use_chunking(store_type, doc_data):
                        ...
                        print(f"    ✅ Created {len(chunk_result['chunks'])} chunks for {doc_id}")
...
async def verify_migration():
    ...
    try:
        ...
        for i, result in enumerate(results[:3], 1):
            ...
            chunk_type = result.get("chunk_type", "document") if is_chunk else "document"
            
            print(f"    {i}. {doc_id[:60]}... (similarity: {similarity:.3f}, type: {chunk_type})")
