...
class TestFlowWithFallback:
    ...
    async def test_with_fallback_used_for_single_empty_yield(self) -> None:
        ...
        async def conditional_source(stream: AsyncIterator[bool]) -> AsyncIterator[str]:
        ...
        async def false_stream() -> AsyncIterator[bool]:
            yield False
    ...
    async def test_with_fallback_different_types(self) -> None:
        ...
        async def empty_int_source(stream: AsyncIterator[None]) -> AsyncIterator[int]:
            return
            yield  # pragma: no cover
    ...
    async def test_with_fallback_preserves_type_signature(self) -> None:
        ...
        async def empty_string_stream() -> AsyncIterator[str]:
            return
            yield  # pragma: no cover
    ...
    async def test_with_fallback_multiple_fallbacks(self) -> None:
        ...
        async def empty_source(stream: AsyncIterator[None]) -> AsyncIterator[str]:
            return
            yield  # pragma: no cover
    ...
    async def test_with_fallback_single_item_stream(self) -> None:
        ...
        async def single_source(stream: AsyncIterator[None]) -> AsyncIterator[str]:
            yield "only_item"
    ...
    async def test_with_fallback_with_different_input_streams(self) -> None:
        ...
        async def filter_fn(stream: AsyncIterator[int]) -> AsyncIterator[int]:
            async for item in stream:
                if item > 10:
                    yield item
        ...
        async def small_numbers() -> AsyncIterator[int]:
            for i in [1, 5, 8]:
                yield i
        ...
        async def mixed_numbers() -> AsyncIterator[int]:
            for i in [1, 15, 8, 20]:
                yield i
...
class TestFlowBatch:
    ...
    async def test_batch_larger_than_stream(self) -> None:
        ...
        async def small_source(stream: AsyncIterator[None]) -> AsyncIterator[int]:
            for i in [10, 20]:
                yield i
    ...
    async def test_batch_with_different_input_streams(self) -> None:
        ...
        async def transform_fn(stream: AsyncIterator[str]) -> AsyncIterator[str]:
            async for item in stream:
                yield item.upper()
