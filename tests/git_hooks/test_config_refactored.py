...
class TestConfigRefactored:
    ...
    def test_load_file_length_config(self):
        ...
        with patch.dict(os.environ, {
            ...
            config = ValidationConfig._load_file_length_config()
    ...
    def test_load_module_size_config(self):
        ...
        with patch.dict(os.environ, {
            ...
            config = ValidationConfig._load_module_size_config()
    ...
    def test_load_function_length_config(self):
        ...
        with patch.dict(os.environ, {
            ...
            config = ValidationConfig._load_function_length_config()
    ...
    def test_create_threshold_calculators(self):
        """Test creating threshold calculators."""
        calcs = ValidationConfig._create_threshold_calculators()
        assert 'file_calc' in calcs
        assert 'module_calc' in calcs
        assert 'func_calc' in calcs

    def test_from_environment_uses_refactored_methods(self, monkeypatch):
