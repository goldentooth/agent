...
class TestThresholdCalculator:
    ...
    def test_calculate_warn_threshold_default(self):
    ...
    def test_calculate_urgent_threshold_default(self):
    ...
    def test_calculate_warn_threshold_custom_multiplier(self):
    ...
    def test_calculate_urgent_threshold_custom_multiplier(self):
    ...
    def test_both_custom_multipliers(self):
    ...
    def test_thresholds_rounded_correctly(self):
