...
from flow.registry import FlowRegistry, flow_registry, registered_flow
...
class TestRegistryPersistence:
    ...
    def test_export_json(self) -> None:
        ...
        from flow.registry import export_registry
    ...
    def test_import_round_trip(self) -> None:
        ...
        from flow.registry import export_registry, import_registry
