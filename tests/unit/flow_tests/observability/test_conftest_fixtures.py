...
from flow.observability.analysis import FlowAnalyzer
from flow.observability.debugging import FlowDebugger
from flow.observability.health import FlowHealthMonitor
from flow.observability.performance import PerformanceMonitor
...
class TestObservabilityFixtures:
    ...
    def test_flow_analyzer_fixture(self, flow_analyzer: FlowAnalyzer) -> None:
    ...
    def test_flow_debugger_fixture(self, flow_debugger: FlowDebugger) -> None:
    ...
    def test_health_monitor_fixture(self, health_monitor: FlowHealthMonitor) -> None:
