...
from flow.observability.health.checks import FlowHealthMonitor
from flow.observability.health.core import HealthStatus
...
class TestFlowHealthMonitor:
    ...
    def test_determine_overall_status(self) -> None:
        ...
        # Test all healthy
        from flow.observability.health.core import HealthCheckResult
    ...
    def test_get_health_history(self) -> None:
        ...
        from flow.observability.health.core import SystemHealth
...
class TestBuiltInHealthChecks:
    ...
    async def test_check_flow_performance(self) -> None:
        ...
        from flow.observability.health.checks import check_flow_performance
    ...
    async def test_check_flow_errors(self) -> None:
        ...
        from flow.flow import Flow
        from flow.observability.health.checks import check_flow_errors
    ...
    async def test_check_memory_usage(self) -> None:
        ...
        from flow.observability.health.checks import check_memory_usage
    ...
    async def test_check_flow_dependencies(self) -> None:
        ...
        from flow.flow import Flow
        from flow.observability.health.checks import check_flow_dependencies
    ...
    async def test_check_flow_configuration(self) -> None:
        ...
        from flow.observability.health.checks import check_flow_configuration
    ...
    async def test_check_resource_limits(self) -> None:
        ...
        from flow.observability.health.checks import check_resource_limits
    ...
    async def test_check_flow_responsiveness(self) -> None:
        ...
        from flow.flow import Flow
        from flow.observability.health.checks import check_flow_responsiveness
    ...
    async def test_check_system_resources(self) -> None:
        ...
        from flow.observability.health.checks import check_system_resources
