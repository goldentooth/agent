...
from flow.combinators.basic import map_stream
from flow.observability.analysis import (
    AnalysisData,
    AnyFlow,
    FlowAnalyzer,
    FlowEdge,
...
class TestAnalysisFunctions:
    ...
    def test_find_cycles_function(self) -> None:
        ...
        from flow.observability.analysis import find_cycles
    ...
    def test_calculate_dependencies_function(self) -> None:
        ...
        from flow.observability.analysis import calculate_dependencies
    ...
    def test_visualize_flow_graph_dot_format(self) -> None:
        ...
        from flow.observability.analysis import visualize_flow_graph
    ...
    def test_optimize_flow_composition_function(self) -> None:
        ...
        from flow.observability.analysis import optimize_flow_composition
