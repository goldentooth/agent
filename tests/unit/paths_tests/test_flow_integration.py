...
class TestPathsFlowIntegration:
    ...
    @pytest.mark.asyncio
    async def test_path_exists_filter(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_resolve_config_path(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_resolve_data_path(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_directory_flow(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_ensure_parent_dir(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_read_config_file_existing(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_read_config_file_missing(self) -> None:
        """read_config_file should return default for missing files."""
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch("paths.main.PlatformDirs") as mock_dirs:
    ...
    @pytest.mark.asyncio
    async def test_write_config_file(self) -> None:
