...
class InvalidAdapter:
    ...
    def from_dict(self, data: dict) -> User:  # Missing @classmethod - this makes it invalid
...
class TestIntegration:
    ...
    def test_complete_workflow(self):
        ...
        # Create stores
        templates_store = YamlStore[User](
            self.base_path / "templates", 
            UserAdapter
        )
        user_store = YamlStore[User](
