...
class TestVectorStore:
    ...
    def test_search_similar_basic(self):
        ...
        documents = [
            ("github.repos", "ml-repo", "Machine learning algorithms", [1.0, 0.0] + [0.0] * 766),
            ("github.repos", "web-repo", "Web development framework", [0.0, 1.0] + [0.0] * 766),
            ("notes", "ml-note", "Machine learning best practices", [0.9, 0.1] + [0.0] * 766),
        ]
    ...
    def test_search_similar_with_store_type_filter(self):
        ...
        self.vector_store.store_document(
            "notes", "note1", "Note content", [1.0] * 768
        )
    ...
    def test_get_stats(self):
        ...
        # Add some documents
        self.vector_store.store_document("github.repos", "repo1", "Content 1", [0.1] * 768)
        self.vector_store.store_document("github.repos", "repo2", "Content 2", [0.2] * 768)
