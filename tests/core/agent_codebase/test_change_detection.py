...
class TestSmartChangeDetector:
    ...
    def test_generate_fingerprint(
        ...
        sample_document: CodebaseDocument,
        temp_dir: Path,
    ):
        ...
        assert (
            ...
            == sample_document.line_end - sample_document.line_start
        )
...
'''
    ...
    def test_analyze_document_changes_new_document(
        self,
        change_detector: SmartChangeDetector,
        sample_document: CodebaseDocument,
        temp_dir: Path,
        ...
        needs_embedding, fingerprint = change_detector.analyze_document_changes(
            sample_document, test_file
        )
    ...
    def test_analyze_document_changes_unchanged(
        self,
        change_detector: SmartChangeDetector,
        sample_document: CodebaseDocument,
        temp_dir: Path,
        ...
        needs_embedding, new_fingerprint = change_detector.analyze_document_changes(
            sample_document, test_file
        )
    ...
    def test_analyze_document_changes_semantic_change(
        self,
        change_detector: SmartChangeDetector,
        sample_document: CodebaseDocument,
        temp_dir: Path,
        ...
        modified_doc.content = modified_doc.content.replace(
            "x * 2", "x * 3"
        )  # Change logic
        modified_doc.docstring = (
            "A sample function that triples input"  # Change meaning
        )
    ...
    def test_cleanup_stale_documents(
        self, change_detector: SmartChangeDetector, temp_dir: Path
    ):
