...
.. code-block:: python
   ...
   from flowengine.combinators import get_function_name, create_single_item_stream
...
.. code-block:: python
   ...
   from flowengine import Flow
   from flowengine.combinators import map_stream, filter_stream, take_stream
...
.. code-block:: python
   ...
   import time
   from flowengine.combinators import metrics_stream
...
.. code-block:: python
   ...
   import pytest
   from flowengine import Flow
   from flowengine.combinators import map_stream
